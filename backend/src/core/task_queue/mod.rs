...
pub(crate) use types::PriorityTask;
pub use types::{BackoffStrategy, Priority, RetryPolicy, Task, TaskPayload, TaskStatus};
...
impl TaskQueue {
    ...
    pub async fn enqueue_scan_library(
        &self,
        library_id: &str,
        library_path: &str,
