...
| 详情概览 | 章节管理 | 元数据编辑 |
| :---: | :---: | :---: |
| <img src="image/书籍详情.jpg" width="200"> | <img src="image/书籍详情-章节管理.jpg" width="200"> | <img src="image/书籍详情-编辑书籍元数据.jpg" width="200"> |
...
<details>
<summary><b>🖥️ 桌面端界面 (点击展开)</b></summary>

#### 🔹 主菜单
| 首页 |
| :---: |
| <img src="image/桌面端-首页.jpg" width="600"> |

| 书架 |
| :---: |
| <img src="image/桌面端-书架.jpg" width="600"> |

| 搜索 |
| :---: |
| <img src="image/桌面端-搜索.jpg" width="600"> |

| 收藏 |
| :---: |
| <img src="image/桌面端-收藏.jpg" width="600"> |

#### 🔹 书籍详情与管理
| 书籍详情（含章节列表与播放小窗） |
| :---: |
| <img src="image/桌面端-书籍详情.jpg" width="600"> |

| 编辑书籍元数据 |
| :---: |
| <img src="image/桌面端-书籍详情-编辑书籍元数据.jpg" width="600"> |

| 章节管理 |
| :---: |
| <img src="image/桌面端-书籍详情-章节管理.png" width="600"> |

#### 🔹 后台管理
| 存储库管理 |
| :---: |
| <img src="image/桌面端-存储库管理.jpg" width="600"> |

| 编辑存储库 |
| :---: |
| <img src="image/桌面端-编辑存储库弹窗.jpg" width="600"> |

| 系统日志 |
| :---: |
| <img src="image/桌面端-系统日志.jpg" width="600"> |

| 插件管理 |
| :---: |
| <img src="image/桌面端-插件管理.jpg" width="600"> |

#### 🔹 用户与设置
| 用户管理 |
| :---: |
| <img src="image/桌面端-用户管理.jpg" width="600"> |

| 创建用户 |
| :---: |
| <img src="image/桌面端-创建用户弹窗.jpg" width="600"> |

| 系统设置 - 账号与外观 |
| :---: |
| <img src="image/桌面端-系统设置-账号设置.jpg" width="600"> |

| 系统设置 - 播放偏好 |
| :---: |
| <img src="image/桌面端-系统设置-播放偏好.jpg" width="600"> |

</details>

## ✨ 功能特性

- ⚡ **Rust 核心**：后端采用 Rust 编写，资源占用低，响应速度快。
...
正式版 Release 会同时提供前端静态包、Linux amd64/arm64 后端包和交互式部署脚本。脚本会自动识别系统架构，并引导选择交互语言、GitHub 镜像加速、版本、监听地址（Host）、端口、数据目录、默认存储库及额外本地存储库路径。启用镜像后，前后端下载地址会自动添加 `https://gh-proxy.org/` 前缀。

```bash
curl -fL https://github.com/dqsq2e2/ting-reader/releases/latest/download/deploy.sh -o deploy.sh
chmod +x deploy.sh
./deploy.sh
```

部署时可选择系统级 `systemd`、用户级 `systemd` 或仅生成文件后手动运行。当前本地发布包支持 Linux `amd64` 与 `arm64`。部署完成后可运行 `ting-reader-library` 添加并授权本地存储库，运行 `ting-reader-update` 更新前后端并保留配置、数据库、插件和媒体文件，运行 `ting-reader-uninstall` 安全卸载前后端。
