...
| 首页 | 书架 | 搜索 | 收藏 |
| :---: | :---: | :---: | :---: |
| <img src="image/桌面端-首页.jpg" width="400"> | <img src="image/桌面端-书架.jpg" width="400"> | <img src="image/桌面端-搜索.jpg" width="400"> | <img src="image/桌面端-收藏.jpg" width="400"> |

#### 🔹 书籍详情与管理
| 书籍详情（含章节列表与播放小窗） | 编辑书籍元数据 | 章节管理 |
| :---: | :---: | :---: |
| <img src="image/桌面端-书籍详情.jpg" width="400"> | <img src="image/桌面端-书籍详情-编辑书籍元数据.jpg" width="400"> | <img src="image/桌面端-书籍详情-章节管理.png" width="400"> |

#### 🔹 后台管理
| 存储库管理 | 编辑存储库 | 系统日志 | 插件管理 |
| :---: | :---: | :---: | :---: |
| <img src="image/桌面端-存储库管理.jpg" width="400"> | <img src="image/桌面端-编辑存储库弹窗.jpg" width="400"> | <img src="image/桌面端-系统日志.jpg" width="400"> | <img src="image/桌面端-插件管理.jpg" width="400"> |

#### 🔹 用户与设置
| 用户管理 | 创建用户 | 系统设置 - 账号与外观 | 系统设置 - 播放偏好 |
| :---: | :---: | :---: | :---: |
| <img src="image/桌面端-用户管理.jpg" width="400"> | <img src="image/桌面端-创建用户弹窗.jpg" width="400"> | <img src="image/桌面端-系统设置-账号设置.jpg" width="400"> | <img src="image/桌面端-系统设置-播放偏好.jpg" width="400"> |
